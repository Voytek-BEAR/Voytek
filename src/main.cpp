...
#if defined(NDEBUG)
#error "Voytek cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {  nSubsidy = 2537975 * COIN; }
    else if (nHeight < 5242200 && nHeight >= 1) { nSubsidy = 3.522 * COIN; }
    else { nSubsidy = 0.8 * COIN; }
