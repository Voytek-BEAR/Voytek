...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Voytek BEAR voytek-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  voytek-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded voytek transaction") + "\n" +
                               "  voytek-tx [options] -create [commands]   " + _("Create hex-encoded voytek transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded voytek transaction
