...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Voytek features */
        {"voytek", "masternode", &masternode, true, true, false},
        {"voytek", "listmasternodes", &listmasternodes, true, true, false},
        {"voytek", "getmasternodecount", &getmasternodecount, true, true, false},
        {"voytek", "masternodeconnect", &masternodeconnect, true, true, false},
        {"voytek", "masternodecurrent", &masternodecurrent, true, true, false},
        {"voytek", "masternodedebug", &masternodedebug, true, true, false},
        {"voytek", "startmasternode", &startmasternode, true, true, false},
        {"voytek", "createmasternodekey", &createmasternodekey, true, true, false},
        {"voytek", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"voytek", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"voytek", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"voytek", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"voytek", "getmasternodescores", &getmasternodescores, true, true, false},
        {"voytek", "mnbudget", &mnbudget, true, true, false},
        {"voytek", "preparebudget", &preparebudget, true, true, false},
        {"voytek", "submitbudget", &submitbudget, true, true, false},
        {"voytek", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"voytek", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"voytek", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"voytek", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"voytek", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"voytek", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"voytek", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"voytek", "checkbudgets", &checkbudgets, true, true, false},
        {"voytek", "mnsync", &mnsync, true, true, false},
        {"voytek", "spork", &spork, true, true, false},
        {"voytek", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"voytek", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use voytekd, or the -server option to voytek-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> voytek-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18181/\n";
}
