...
/** Utility functions used by the Voytek Qt UI.
 */
namespace GUIUtil
{
...
// Render Voytek addresses in monospace font
...
// Parse "voytek:" URI into recipient object, return true on successful parsing
