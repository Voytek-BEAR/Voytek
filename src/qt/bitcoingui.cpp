                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Voytek BEAR") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Voytek address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and voytek: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Voytek BEAR"), this);
    aboutAction->setStatusTip(tr("Show information about Voytek BEAR"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Voytek"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Voytek addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Voytek addresses"));
    ...
    openAction->setStatusTip(tr("Open a Voytek: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Voytek BEAR help message to get a list with possible Voytek command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Voytek BEAR client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Voytek network", "", count));
}
...
{
    QString strTitle = tr("Voytek BEAR"); // default title
