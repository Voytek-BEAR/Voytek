...
In order to support loading of multiple wallets in voytek-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is voytek.cpp.
...
Changes to voytek.cpp
----------------------
voytek.cpp is the entry point into voytek-qt, and as such, will require some minor modifications to provide hooks for
